...
if(isset($_POST['submit'])&&isset($_POST['taskName']))
{
    ...
    $delete="DELETE FROM userTasks WHERE userName='$userName' AND taskName='$taskName'";
    if($con->query($delete))
    {
        header('Location:detailTask.php');
        exit;
    }
}
...
<div class="table pt-2 pb-5">
<div class="container pt-5 pb-x 5">
...
if($flag=="1")
{
  ...
  <strong>Warning !</strong> You should check on checkbox feild 
...
<table class='table  table-striped table-bordered'>
    ...
    $tableShowTasks="";
        ...
        while($row=$result->fetch_assoc())
        {
            ...
            <tr>
                ...
                <td>".$row['taskExpirationDate']."</td>
                <td>".$row['taskCatagory']."</td>
                <td>".$row['priorityTask']."</td>
                <td>".$row['taskDescription']."</td>
                <td> 
                <form method='post' action='' class='form-check'>
                <button type='submit' name='submit'class='ps-1' >
                <i class='fa-regular fa-trash-can'></i>
                </button>
                <input type='checkbox' class='form-check-input' value='".$row['taskName']."' name='taskName'>
                </form>
                </td>
            </tr>
            ".$tableShowTasks;
    ...
    $tableShowTasks=$tableShowTasks."</table>";
    echo $tableShowTasks;
